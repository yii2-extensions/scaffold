 ...
 *
 * Supports both inline `extra.scaffold.file-mapping` declarations and external
 * `extra.scaffold.manifest` JSON files relative to the provider root.
 *
...
final class ManifestLoader
{
    public function __construct(
        private readonly ManifestSchema $schema,
    ) {}
    ...
    /**
     * @param array<string, array{source: string, mode: string}> $fileMapping
     *
     * @return list<FileMapping>
     */
